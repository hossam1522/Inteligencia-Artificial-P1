...
public:
  ...
  void girar45JugadorIzquierda() { mapa->girarCamaraIzquierda(45); }
  void girar45JugadorDerecha() { mapa->girarCamaraDerecha(45); }
  void girar135JugadorIzquierda() { mapa->girarCamaraIzquierda(135); }
  void girar135JugadorDerecha() { mapa->girarCamaraDerecha(135); }
